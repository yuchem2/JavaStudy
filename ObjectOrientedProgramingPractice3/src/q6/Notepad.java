...
/**
 * Notepad: https://www.javatpoint.com/notepad OpenSource code
 * I change some part code line: 257, 266-276, 338~347, 569, 620, 630, 637, 677, 710
 * 
 * @author JaeHyun Yoon
 * @since 06-09-2023
 */
...
public class Notepad implements ActionListener, MenuConstants {
	...
	JMenuItem cutItem, copyItem, deleteItem, findItem, findNextItem, replaceItem, gotoItem, selectAllItem, myMenuItem; // change
																														// part
	...
	Notepad() {
		...
		// Change part
		ta.setBackground(new Color(255, 153, 255));
		ta.setForeground(new Color(255, 130, 182));

		JButton lblClick = new JButton("Click Here");
		lblClick.setBounds(575 / 2 - 50, 560, 100, 30);

		JScrollPane textField = new JScrollPane(ta);
		textField.setBounds(7, 0, 550, 600);

		JLayeredPane layeredPane = new JLayeredPane();
		layeredPane.add(textField, JLayeredPane.DEFAULT_LAYER);
		layeredPane.add(lblClick, JLayeredPane.PALETTE_LAYER);
...
/////////
		...
		// change part
		lblClick.addActionListener(new ActionListener() {
...
////////////////////////////////////
		...
		} else if (cmdText.equals(myMenuCopyEvent)) {
			if (ta.getText().length() != 0) {
				String buff = ta.getText();
				ta.append(System.lineSeparator());
				ta.append(buff);
...
////////////////////////////////////
	...
	void createMenuBar(JFrame f) {
		...
		// change part
		JMenu myMenu = createMenu(myMenuText, KeyEvent.VK_M, mb);
		...
		// change part
		myMenuItem = createMenuItem(myMenuCopyEvent, KeyEvent.VK_F1, myMenu, this);
		...
		MenuListener editMenuListener = new MenuListener() {
			public void menuSelected(MenuEvent evvvv) {
				if (Notepad.this.ta.getText().length() == 0) {
					...
					myMenuItem.setEnabled(false); // change part
				} else {
					...
					myMenuItem.setEnabled(true); // change part
				}
...
interface MenuConstants {
	...
	// change part
	final String myMenuText = "MyMenu";
	...
	// change part
	final String myMenuCopyEvent = "Copy Event";
